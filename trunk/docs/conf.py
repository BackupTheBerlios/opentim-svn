...
project = u"OpenTIM Developer's Reference"
copyright = u'2008, Luc Saffre'
...
latex_documents = [
  ('index', 'otimdev.tex', ur'otimdev', ur'Luc Saffre', 'manual'),
]
...
sfile_base_uri="http://svn.berlios.de/wsvn/opentim/trunk"

from docutils import nodes, utils
import posixpath

def sfile_role(typ, rawtext, etext, lineno, 
