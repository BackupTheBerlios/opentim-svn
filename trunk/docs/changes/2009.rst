...
- :func:`TplInclude` hat ein spezielles Verhalten, wenn cIdTpl Leerzeichen enthält: dann wird cIdTpt ersetzt durch den Teil von cIdTpl vor dem Leerzeichen. Aber LstHaushalt() machte ein padr() von cIdTpl, dadurch missverstanden die beiden sich. Jetzt macht TplInclude() ein trim(cIdTpl), bevor sie dort nach Leerzeichen sucht.
