...
[etc endif] \
\hfill
[=alltrim(substr(MemName3,at(" ",MemName3)))], [=tr("","den","le")] [ven date]
...
[etc if MemPays=="EE "]
[="KM 0% vastavalt KMS õ 15 lg 4 p 1 (direktiiv art 21)."]
[etc endif]
\raggedright
\nopagebreak
[etc endif]
...
[etc endif]
[****** Ihre MWSt-Nummer **********]
[etc if DlgValue("IsFacture").and.!empty(PAR->NoTva)]
...
[etc if DlgValue("IsFacture").and.!VenIsNc().and.!VEN->IdMfc$"BAR,DOM"]
  [etc if TplLang()=="F"]
    R‚f‚rence paiement~: [=VEN->IdDoc].
  [etc endif]
  [etc if TplLang()=="D"]
    Bei Zahlung bitte angeben: [=VEN->IdDoc].
  [etc endif]
[etc endif]
[****** Salutations]
